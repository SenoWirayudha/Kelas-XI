...
@section('page-subtitle', 'Buat jadwal tayang baru')
...
<div class="p-6 max-w-2xl">
    ...
    <div class="bg-white rounded-xl shadow p-6">
        ...
        <form action="{{ route('admin.schedules.store') }}" method="POST" x-data="scheduleForm()" x-init="init()">
            @csrf

            {{-- Film --}}
            <div class="mb-5">
                <label class="block text-sm font-medium text-gray-700 mb-1">Film <span class="text-red-500">*</span></label>
            ...
            {{-- Bioskop --}}
            <div class="mb-5">
                <label class="block text-sm font-medium text-gray-700 mb-1">Bioskop <span class="text-red-500">*</span></label>
            ...
            <div class="grid grid-cols-2 gap-4 mb-5">
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-1">Tanggal Tayang <span class="text-red-500">*</span></label>
            ...
            {{-- Harga --}}
            <div class="mb-6">
                <label class="block text-sm font-medium text-gray-700 mb-1">Harga Tiket (Rp) <span class="text-red-500">*</span></label>
                <input type="number" name="ticket_price" required min="0" step="500"
                       value="{{ old('ticket_price', 50000) }}"
                       class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-blue-500 focus:outline-none">
            </div>
