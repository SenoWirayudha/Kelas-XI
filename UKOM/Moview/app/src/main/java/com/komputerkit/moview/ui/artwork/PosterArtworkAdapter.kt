...
import com.komputerkit.moview.databinding.ItemPosterArtworkBinding

class PosterArtworkAdapter(
    private val onArtworkClick: (Artwork) -> Unit
) : ListAdapter<Artwork, PosterArtworkAdapter.ArtworkViewHolder>(ArtworkDiffCallback()) {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ArtworkViewHolder {
        val binding = ItemPosterArtworkBinding.inflate(
    ...
    class ArtworkViewHolder(
        private val binding: ItemPosterArtworkBinding,
        private val onArtworkClick: (Artwork) -> Unit
